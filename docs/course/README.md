...
| [Starter Kit Contract](../starter-kit-contract.md) | P0 架构、公共接口、组件插槽、文件所有权和测试契约 | 老师、学生、AI Agent |
...
老师和助教先维护[课程设计](./course-design.md)，通过 Reference Implementation 验证工作量与接口后，再生成 `docs/specs/` 下的正式文件和对应 GitHub Issues。
